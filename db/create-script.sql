...
alter table "mesurements" add constraint "mesurement_blok" foreign key ("block_id") references "blocks" ("id") on delete cascade on update cascade; -- with deletion of block remove all mesurements within the block
...
alter table "mesurements" add constraint "mesurement_location" foreign key ("block_id") references "locations" ("id") on delete restrict on update cascade;
